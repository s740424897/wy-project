<template>
  <header class="header-box">
    ...
    <div class="header-nav">
      <div class="left-ul-box">
        <ul class="left-ul clearfix" @click="addActive($event)">
      ...
      <div class="all-nav-box" v-show="isOpen">
        <p>全部频道</p>
        <ul class="all-nav clearfix" ref="allNav">
...
<script>
  ...
  export default {
    ...
    mounted () {
      this.$nextTick(()=>{
        if(!this.Bscroll){
          this.Bscroll = new BScroll(".left-ul-box",{
            scrollX:true,
            click:true
          })
        }else {
